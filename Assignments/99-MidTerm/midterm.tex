...
\NormalTok{SemanticSurprise s2(}\DecValTok{4}\NormalTok{);       }\CommentTok{// Parameterized Constructor}
\NormalTok{s2.value();                   }\CommentTok{// 4}

\NormalTok{SemanticSurprise s3 = s2;     }\CommentTok{// Copy Constructor}
\NormalTok{s3.value();                   }\CommentTok{// 4}

\NormalTok{SemanticSurprise s4(s3);      }\CommentTok{// Copy Constructor}
\NormalTok{s4 == s3;                     }\CommentTok{// True}
