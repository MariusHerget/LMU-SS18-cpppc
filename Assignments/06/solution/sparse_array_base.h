...
namespace detail {
  ...
  class RandomAccessIteratorBase {
	  private:
		  ...
		  using self_t = RandomAccessIteratorBase<Derived,T>;
	  ...
	  public:
		  ...
		  using proxy_reference = sparse_array_proxy_ref<T>;
		  using const_reference = const value_type &;
		  using pointer = value_type *;
		  using reference = proxy_reference;
		  // using const_reference = typename derived_t::const_reference;
		  // using difference_type = typename derived_t::difference_type;
  ...
  class sparse_array_iterator
	      : public RandomAccessIteratorBase<sparse_array_iterator<SparseArrayT>, SparseArrayT>
  {
	  private:
		  using index_t = typename SparseArrayT::index_t;
		  using self_t = sparse_array_iterator<SparseArrayT>;
		  using base_t = RandomAccessIteratorBase<sparse_array_iterator<SparseArrayT>, SparseArrayT>;
	  public:
