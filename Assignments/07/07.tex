...
\item
  ...
  ranges?
    \problemAnswer{
        \begin{itemize}
            \item remove/remove\_if --> Not in real only a partition which moves elements behind the iterator
            \item remove\_copy/remove\_copy\_if --> Not in real only a partition which moves elements behind the iterator
